<template>
  <transition name="el-zoom-in-top" @after-leave="doDestroy">
    <div class="color-container" v-show="showPopper">
      <p :class="{selected: this.colorValue === 'NONE'}" @click="change('none')" v-show="showTransparent">无色</p>
      <p v-show="showGrandient">渐变</p>
...
export default {
  ...
  props: {
    'color-value': String,
    'show-grandient': Boolean,
    'show-transparent': Boolean
  },
  methods: {
    pick (val) {
